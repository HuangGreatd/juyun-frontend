...
export async function helloUsingGet(
  ...
  return request<string>('/api/hello', {
    method: 'GET',
    params: {
      // name has a default value: unknown user.ts
      name: 'unknown user.ts',
      ...params,
    },
    ...(options || {}),
  })
